...
module.exports.otpTemp =function(name,otp) { 
let otpTemp=`<!doctype html>
 <html lang="en">
     <head>
         <meta charset="utf-8">
             ...
             <tr>
                 <td>
                     <table width="600" border="0" style="margin:0 auto">
                         <tr>
                             <td>
                                 <h3 style="margin:30px 0; color:#6863FA;font-family:'Poppins', sans-serif;font-size: 24px;">OTP Verification</h3>
                             </td>
                         </tr>
                         <tr>
                             <td>
                                 <p  style="margin:20px 0; color:#000;font-family:'Poppins', sans-serif;font-size:16px;line-height: 24px;">Dear `+name+`,</p>
                             </td>
                         </tr>
                         <tr>
                             <td>
                                 <p  style="margin:20px 0; color:#000;font-family:'Poppins', sans-serif;font-size:16px;line-height: 24px;">Your verification code is: `+otp+`</p>
                             </td>
                         </tr>
...
// Dear [First Name],
// Your verification code is: [insert number]
