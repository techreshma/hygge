module.exports.ChatHistoryTemp =function(name) { 
let ChatHistoryTemp=`<!doctype html>
<html lang="en">
	<head>
		<meta charset="utf-8">
		<title>Email</title>
			...
			<tr>
				<td>
					<table width="600" border="0" style="margin:0 auto">
						<tr>
							<td>
								<h3 style="margin:30px 0; color:#6863FA;font-family:'Poppins', sans-serif;font-size: 24px;">Message log on Hygge  [insert date, time]</h3>
							</td>
						</tr>
						<tr>
							<td>
						...
						<tr>
							<td>
								<p  style="margin:20px 0; color:#000;font-family:'Poppins', sans-serif;font-size:16px;line-height: 24px;">Chat message history email</p>
							</td>
						</tr>
						<tr>
							<td>
								<p  style="margin:20px 0; color:#000;font-family:'Poppins', sans-serif;font-size:16px;line-height: 24px;">
								Please see attached your message log for the last 3 months.
								</p>
							</td>
						</tr>
